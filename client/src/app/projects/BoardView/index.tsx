...
const TaskColumn = ({
  ...
  return (
    <div
      ...
      className={`rounded-lg py-2 md:py-4 xl:px-2 ${isOver ? "bg-blue-100 dark:bg-neutral-950" : ""}`}
    >
    ...
    >
      ...
      <div className="p-4 md:p-6">
        <div className="flex items-start justify-between">
          ...
          <button className="itmes-center flex h-6 w-4 flex-shrink-0 justify-center dark:text-neutral-500">
            <EllipsisVertical size={26} />
          </button>
        </div>
